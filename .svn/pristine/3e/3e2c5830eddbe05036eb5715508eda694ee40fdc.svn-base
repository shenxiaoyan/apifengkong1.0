...
public class ParameterService {
    ...
    //根据传入的参数查询相应接口
	public HashMap<SupplyAPI, HashMap<String, String>> findSupplyAPIsAndTransform(final Map<String, String> parameters) {
	...
	public HashMap<SupplyAPI, HashMap<String, String>> findSupplyAPIAndTransform(HashMap<String, String> inputParameterConvert) {
