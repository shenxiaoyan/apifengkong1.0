...
public class ApiSearchController {
	...
	public Map smartSearch(HttpServletRequest request) {
		...
		HashMap<SupplyAPI, HashMap<String, String>> apis = parameterService.findSupplyAPIsAndTransform(parameters);
		Map<String, Map> results = baseSearchService.search(apis, customer);
	...
	public Map normalSearch(HttpServletRequest request) {
		...
		HashMap<SupplyAPI, HashMap<String, String>> apis = parameterService.findSupplyAPIAndTransform(inputParameterConvert);
